...
import kotlinx.android.synthetic.main.widget_test_view_b.view.*
...
class ExampleFloatingService : Service() {
    ...
    override fun onCreate() {
        ...
        mExampleViewB.two_tv.setText(Config.content)
...
//        } else
        if (!mFloatingWindowHelper.contains(mExampleViewB)) {
            mFloatingWindowHelper.addView(mExampleViewB, 0, 0, true)
        } else {
